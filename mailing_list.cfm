										   ...
										   <cfif phoneError>
											<!--- <cfdump var="testing 2" abort="true"> --->
											  ...
											  <cfelse>
												...
												<cfif form.fname neq '' and form.lname neq '' and form.comments neq '' and form.email neq '' and form.phone neq '' and form.otherphone neq '' and form.list>
													<cftry>
											  ...
											  <CFFORM ACTION="#script_name#" METHOD="POST" enctype="multipart/form-data">
												 ...
												 <div class="input-form">
													<div class="input-field">
													   <label><FONT face="verdana,arial,helvetica" color="000000"><b>FIRST NAME<span style="color: ##ff0000;">*</span> </b></FONT></label>
													   <cfinput type="text" size=40 maxsize=50 name="fname" value="#form.fname#" required="Yes" MESSAGE="Please fill in your first name.">
													</div>
													<div class="input-field">
													   <label><FONT face="verdana,arial,helvetica" color="000000"><b>LAST NAME<span style="color: ##ff0000;">*</span></b></FONT></label>
													   <cfinput type="text" size=40 maxsize=50 name="lname" value="#form.lname#" required="Yes" MESSAGE="Please fill in your last name.">
													</div>
													<div class="input-field">
													   <label><FONT face="verdana,arial,helvetica" color="000000"><b>E-MAIL ADDRESS<span style="color: ##ff0000;">*</span></b></FONT></label>
													...
													<div class="input-field">
													   ...
													   the image above:<span style="color: ##ff0000;">*</span></b></FONT></label>
