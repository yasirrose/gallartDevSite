																						...
																						<cfform action="" method="post" name="frm1">
																							...
																							<div class="input-form">
																								...
																								<div class="input-field">
																									...
																									<cfinput type="text" size=40 maxsize=50 name="phone" value="#form.phone#" required="No"
																										MESSAGE="Please fill in your home phone with a proper number." mask="(999) 999-9999">
																								</div>
																								<div class="input-field">
																								...
																								<div class="input-field">
																									...
																									<div class="checkbox">
																										<div class="checkbox-field">
																											<input
																											type="checkbox" name="email_only" value="1" <cfif form.email_only EQ 1>checked
																										</cfif> />
																										</div>
																									</div>	
																								</div>
