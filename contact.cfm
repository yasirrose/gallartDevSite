...
<cfsilent>
 ...
 <cfset pageTitle = "Contact Gallart | Fine Art Gallery in Aventura">
 <cfset pageDescription = "Contact Gallart in Aventura, Florida for buying, selling, appraisals, consignments, and general fine art inquiries.">
 <cfset pageCanonicalPath = "/contact-us/">
	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	   ...
	   <script>
		 function validateForm(e) {
			...
			const phoneType = phoneTypeField.value;
