				...
				<div class="row input-form">
						<div class="col-lg-2 col-md-4 col-sm-6 col-12 mb-3">
							<div class="select-option input-field">
								<select name="artSubject" class="chosen-select m-0" data-placeholder="Search by Subject" onChange="drop('recent-acquisitions?Subject=', 'artSubject')">
						...
						<div class="col-lg-2 col-md-4 col-sm-6 col-12 mb-3">
							<div class="select-option input-field">
								<select name="artStyle" class="chosen-select m-0" data-placeholder="Search by Style" onChange="drop('recent-acquisitions?Style=', 'artStyle')">
					...
					<div class="col-lg-2 col-md-4 col-sm-6 col-12 mb-3">
						<div class="select-option input-field">
							<select name="artSize" class="chosen-select m-0" data-placeholder="Search by Size" onChange="drop('recent-acquisitions?Size=', 'artSize')">
					...
					<div class="col-lg-2 col-md-4 col-sm-6 col-12 mb-3">
						<div class="select-option input-field">
							<select name="artType" class="chosen-select m-0" data-placeholder="Search by Type" onChange="drop('recent-acquisitions?Type=', 'artType')">
