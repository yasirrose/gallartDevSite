				...
				<tr>
					<td colspan="2" width="100%" valign="top" align="center">
						<table cellspacing="0" cellpadding="10" border="0" width="600">
							...
							<tr>
								<td colspan="2">
									<span style="color:##ff0000;">One phone number is required:
								</td>
							</tr>
							<tr>
								<td align="right">
								...
								<td>
									<cfinput type="Text" name="phone" value="#form.phone#" size="40" mask="(999) 999-9999" /> (xxx) xxx-xxxx
								</td>
							</tr>
							<tr>
								<td align="right">
								...
								<td>
									<cfinput type="Text" name="cell" value="#form.cell#" size="40" mask="(999) 999-9999" /> (xxx) xxx-xxxx
								</td>
							</tr>
							<tr>
								<td align="right">
							...
							<tr>
								...
								<td>
									<input type="Text" name="graphics" value="#form.graphics#" size="40" />&nbsp;<input type="Text" name="edition" value="#form.edition#" size="5" />&nbsp;Edition ##
								</td>
							</tr>
							<tr>
								<td align="right">
								...
								<td>
									<cfif form.signature EQ "Hand Signed">
										<input type="radio" name="signature" value="Hand Signed" checked>&nbsp;hand signed&nbsp;&nbsp;<input type="radio" name="signature" value="Plate Signed">&nbsp;plate signed
									<cfelseif form.signature EQ "Plate Signed">
										<input type="radio" name="signature" value="Hand Signed">&nbsp;hand signed&nbsp;&nbsp;<input type="radio" name="signature" value="Plate Signed" checked>&nbsp;plate signed
									<cfelse>
										<input type="radio" name="signature" value="Hand Signed" checked>&nbsp;hand signed&nbsp;&nbsp;<input type="radio" name="signature" value="Plate Signed">&nbsp;plate signed
									</cfif>
									&nbsp;&nbsp;<a href="##TB_inline?height=600&width=550&inlineId=signature_help&modal=true" class="thickbox" style="color: ##dd3a7d; text-decoration: underline;">Help?</a>
								</td>
							</tr>
							<tr>
								<td align="right">
								...
								<td>
									<input type="Text" name="size" value="#form.size#" size="40" />&nbsp;&nbsp;Height x Width
								</td>
							</tr>
							<tr>
								<td align="right">
								...
								<td>
									<input type="Text" name="sculpture" value="#form.sculpture#" size="40" />&nbsp;&nbsp;Height x Width x Depth
								</td>
							</tr>
							<tr>
								<td align="right">
