														...
														<div class="list-item">
															...
															<td valign="top" align="Center">
																<a href="/artist/#urlencodedformat(trim(replace(producturl,"'","")) )#/#urlencodedformat(trim(slug))#">
																	...
																	<cfif fileexists("#application.siteBaseUrl#/img/thumbnails/#uid#.jpg") >
																		<IMG SRC="/img/#uid#.jpg?x=randrange(1,99)"   width="100" BORDER="0" ALT="#trim(modelno)#" align="Center">
																	<cfelse>													
																		<img src="#application.siteBaseUrl#/img/thumbnails/noImage.jfif.jpeg" alt="Artwork image unavailable">
																	</cfif>
																</a>
																<br>
																<a href="/artist/#urlencodedformat(trim(replace(producturl,"'","")) )#/#urlencodedformat(trim(slug))#">
