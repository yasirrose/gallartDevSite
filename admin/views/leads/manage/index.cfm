					...
					<td valign="top">
						...
						<table border = "0" width = "550" cellpadding = "5" cellspacing = "0" class="editBox">
							...
							<tr>
								...
								<td>
									<cfinput type="text" name="name" id="name"  bind="{leadGrid.user_name}" size="30" maxlength="30">
								</td>
							</tr>
							<tr>
								<td style="font-size: 10px;">
							...
							<tr>
								...
								<td>
									<cfinput type="text" name="zip" id="zip"  bind="{leadGrid.zip}" autosuggest="cfc:admin.models.leads.searchLeadsByZipCode({cfautosuggestvalue})" maxResultsDisplay="10" maxlength="10" size="30">
								</td>
							</tr>
