												...
												<div class="imgContainer">
													<div class="gallartLogo"><img src="../images/gallart.gif" /></div>
														<div class="listingImage">
															<!--- <img src="../img/thumbnails/#uid#.jpg" class="resize" height="50"  /> --->
															...
															<cfelse>
																<img src="http://#server_name#/img/thumbnails/noImage.jfif.jpeg" height="50" border="0">
															</cfif>
														</div>
														<div>&nbsp;</div>
													</div>
													...
													<cfif isDefined('form.show_retail')>
														<p><strong>Retail Price:</strong> #dollarFormat(retail_price)#</p>
													</cfif>
													<cfif isDefined('form.show_gallery')>
														<p><strong>Gallery Price:</strong> #dollarFormat(gallery_price)#</p>
													</cfif>
													<cfif isDefined('form.show_sale')>
														<p class="last"><strong>Sale Price:</strong> 
															<cfif form.price_to_use EQ 'sale'>
																#dollarFormat(special_price)#
															<cfelseif form.price_to_use eq 'high estimate'>
																#dollarFormat(high_estimate)#
															</cfif>
														</p>
													</cfif>
												</div>
