...
<cfform method="post" action="index.cfm?event=forms.appraisal_generic_Pdf" enctype="multipart/form-data" onsubmit="return validationAppraisal_genericForm();">
									...
									<td valign="top" style="padding-top: 180px;">
										<table cellspacing="0" cellpadding="3" border="0" width="275">
											<tr>
												...
												<td>
													<input type="Text" name="date" id="date" maxlength="15" style="width: 150px;">
												</td>
											</tr>
											<tr>
												<td class="inputText">
												...
												<td>
													<input type="Text" name="client" id="client" maxlength="30" style="width: 150px;">
												</td>
											</tr>
											<tr>
												<td class="inputText">
												...
												<td width="348">
													<table cellspacing="0" cellpadding="8" border="0" width="250">
														...
														<tr>
															...
															<td align="right">
																<input type="Text" name="condition" id="condition" maxlength="30" style="width: 150px;">
															</td>
														</tr>
														<tr>
...
<script>
		function validationAppraisal_genericForm() {
			console.log('test: ')
