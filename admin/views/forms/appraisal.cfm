...
<cfform method="post" action="index.cfm?event=forms.appraisalPdf" enctype="multipart/form-data" onsubmit="return validationAppraisalForm();">
		...
		<tr>
			<td style="padding-left: 150px;">
				<table cellspacing="0" cellpadding="0" border="0" width="574">
					<tr>
						<td background="http://gallart.com/admin/images/appraisal_bkg2.jpg" width="574" height="717" style="background-repeat: no-repeat;" valign="top">
							<table cellspacing="0" cellpadding="0" border="0" width="100%">
								<tr>
									<td valign="top" style="padding-top: 180px;">
										<table cellspacing="0" cellpadding="3" border="0" width="275">
											<tr>
												...
												<td>
													<input type="Text" id="date" name="date" maxlength="15" style="width: 150px;">
												</td>
											</tr>
											<tr>
												<td class="inputText">
												...
												<td>
													<input type="Text" id="client" name="client" maxlength="30" style="width: 150px;">
												</td>
											</tr>
											<tr>
												<td class="inputText">
												...
												<td>
													<input type="Text" name="address" id="address" maxlength="30" style="width: 150px;">
												</td>
											</tr>
											<tr>
												<td class="inputText">
												...
												<td>
													<input type="Text" name="city" maxlength="20" style="width: 60px;">
													,&nbsp;
													<input type="Text" name="state" maxlength="20" style="width: 60px;">
													&nbsp;
													<input type="Text" name="zip" maxlength="10" style="width: 50px;">
												</td>
											</tr>
										</table>
									</td>
												...
												<td width="348">
													<table cellspacing="0" cellpadding="8" border="0" width="250">
														...
														<tr>
															...
															<td align="right">
																<input type="Text" name="medium" id="medium" maxlength="30" style="width: 150px;">
															</td>
														</tr>
														<tr>
															<td class="inputText">
															...
															<td align="right">
																<input type="Text" name="condition" id="condition" maxlength="20" style="width: 150px;">
															</td>
														</tr>
														<tr>
															<td colspan="2" class="inputText">
																Suggested Retail Value:&nbsp;
																$<input type="Text" name="value" maxlength="6" style="width: 60px;">
															</td>
														</tr>
													</table>
												</td>
...
<script>
		function validationAppraisalForm() {
			console.log('test: ')
