...
<cfoutput>
<cfform method="post" action="index.cfm?event=forms.coapdf" enctype="multipart/form-data">
								...
								<td width="250" valign="top">
									<table cellspacing="0" cellpadding="6" border="0" width="100%">
										<tr>
											...
											<td align="right">
												<input type="Text" name="artist" value="#HTMLEditFormat(form.artist)#" style="width: 150px;">
											</td>
										</tr>
										<tr>
											<td class="inputText">
											...
											<td align="right">
												<input type="Text" name="title" value="#form.title#" style="width: 150px;">
											</td>
										</tr>
										<tr>
											<td class="inputText">
											...
											<td align="right">
												<input type="Text" name="medium" value="#form.medium#" style="width: 150px;">
											</td>
										</tr>
										<tr>
											<td class="inputText">
											...
											<td align="right">
												<input type="Text" name="size" value="#form.size#" style="width: 150px;">
											</td>
										</tr>
										<tr>
											<td class="inputText">
											...
											<td align="right">
												<input type="Text" name="edition" value="#form.edition#" style="width: 150px;">
											</td>
										</tr>
										<tr>
											<td class="inputText">
											...
											<td align="right">
												<input type="Text" name="year" value="#form.year#" style="width: 150px;">
											</td>
										</tr>
									</table>
								</td>
