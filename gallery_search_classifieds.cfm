				...
				<div class="row input-form">
						<div class="col-md-3 mb-3">
							<div class="select-option input-field">
								<select name="artSubject" class="chosen-select m-0" data-placeholder="Search by Subject" onChange="drop('/classifieds/?Subject=', 'artSubject')">
						...
						<div class="col-md-3 mb-3">
							<div class="select-option input-field">
								<select name="artStyle" class="chosen-select m-0" data-placeholder="Search by Style" onChange="drop('/classifieds/?Style=', 'artStyle')">
					...
					<div class="col-md-3 mb-3">
						<div class="select-option input-field">
							<select name="artSize" class="chosen-select m-0" data-placeholder="Search by Size" onChange="drop('/classifieds/?Size=', 'artSize')">
					...
					<div class="col-md-3 mb-3">
						<div class="select-option input-field">
							<select name="artType" class="chosen-select m-0" data-placeholder="Search by Type" onChange="drop('/classifieds/?Type=', 'artType')">
