			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
				<tr height="100%">
					<td valign="top" height="100%">	
						<cfinclude template="left_sales.cfm">
					</td>
				</tr>
			</table>
		</td>
						...
						<table width="600" border="0" cellspacing="0" cellpadding="0" background="images/sales_browse_notext.jpg" style="background-repeat: no-repeat; background-position: -10px top;" width="627" height="127">
							...
							<tr>
								<td valign="top" width="100%">
									<form method="post" action="sales.cfm?xss=#xss#" name="srchForm">
...
<!--- RESULT LIST STARTS --->	
				...
				<tr>
					...
					<cfoutput>
					<form name="frm" action="sales.cfm" method="post">
					...
					<cfoutput query="productinfo" startrow="#startrow#" maxrows="#ipp#">
						...
						<IMG SRC="http://#server_name#/img/thumbnails/#uid#.jpg"  width="100" BORDER="0" ALT="#trim(modelno)#" align="Center">
						</A>
						<Br>
						<A HREF="javascript:goxss('item.cfm?pid=#urlencodedformat(trim(uid))#&artist=#ucase(trim(replace(manufacturer,"'",'')))#&artistname=#urlencodedformat(trim(replace(artist_name_url,"'",'')))#&gallery=GALLART&title=#urlencodedformat(trim(name))#')">
						#name#
					...
					<form name="pagination_form">
					 <cfoutput>
						<Tr bgcolor="ffffff">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<select name="pagego" onChange="javascript:gonext('sales.cfm?pagego=')" style="font-size: 9pt;">
					...
					<table cellspacing="0" cellpadding="6" border="0" align="center" width="100%"  bgcolor="#eeeeee" height="10">
							...
							<font face="Arial, Helvetica, sans-serif" size="1"><A HREF="javascript:gonext2('sales.cfm?pagego=<cfoutput>#preplace#</cfoutput>')">
							...
							<cfif starton neq Totalpages>
								<font face="Arial, Helvetica, sans-serif" size="1"><A HREF="javascript:gonext2('sales.cfm?pagego=<cfoutput>#nextplace#</cfoutput>')">
						Next Page >>
							</a></font>
							</cfif>
							</td>
					...
					<cfelse>
						<div align="center">SORRY - NO SALES ARE LISTED AT THIS TIME USING THOSE SEARCH CRITERIA. <BR />PLEASE SEARCH AGAIN.</div>
					</cfif>
					</td>
						</tr>
					<!--- RESULT LIST ENDS --->												
