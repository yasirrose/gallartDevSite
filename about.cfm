...
<cfset pageTitle = "About Gallart | Fine Art Gallery in Aventura">
<cfset pageDescription = "Learn about Gallart, an Aventura fine art gallery offering curated works, art consulting, appraisals, framing, installations, and worldwide shipping.">
<cfset pageCanonicalPath = "/about-us/">
<html>
	<head>
		<cfoutput>
