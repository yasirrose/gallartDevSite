	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	   ...
	   <cftry>
		  <cfoutput>
			 ...
			 <cfscript>
				// Base URL
				baseURL = "https://gallart.com/item.cfm";
				// Example 'url' struct
				url = {
				artist: url.artist,
												 ...
												 <div class="item-text-content">
													...
													<div class="product-description-sec">
													   ...
													   <cfif edition gt 0>
														  ...
														  <!--- this script is use to convert OF to Of --->
															 ...
															 <cfif structKeyExists(session, 'sellerinfo')>
																...
																<cfform action="" method="POST">
																   ...
																   <!--- <button type="button" class="flex-btn" id="addWishButton" onclick="addWishListRecord()">
																	  <i class="fa fa-heart" id="hearticon" <cfif getwishList.recordCount GT 0>style="color:red !important;"</cfif> ></i>
																	  <span>
																		 Add to wishlist
																	  </span>
																   </button> --->
